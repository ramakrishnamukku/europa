/**
    This file was auto generated by the Distelli Platform.
    http://www.distelli.com/

    Copyright (c) 2013, Distelli Inc, All Rights Reserved
    $Id: $

   Any changes made to this file will be lost on the next build
*/
...
public class RegistryCred implements Comparable
{
    ...
    public String toString() {
        return String.format("RegistryCred[created=%s, description=%s, key=%s, provider=%s, region=%s, secret=%s]", created, description, key, provider, region, secret);
    }
    @Override
    ...
    @Override
    public int hashCode() {
        return Arrays.deepHashCode(new Object[]{created, description, key, provider, region, secret});
    }
