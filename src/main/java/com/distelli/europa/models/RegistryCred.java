...
public class RegistryCred implements Comparable
{
    ...
    public RegistryCred withDescription(String description)
    {
        this.description = description;
        return this;
    }
    ...
    public RegistryCred withName(String name)
    {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        return String.format("RegistryCred[created=%s, description=%s, key=%s, name=%s, provider=%s, region=%s, secret=%s]", created, description, key, name, provider, region, secret);
    }
    @Override
    ...
    public int compareTo(Object obj) {
        ...
        if ( 0 != res ) return res;
        res = ObjectComparator.compareTo(description, other.description);
        if ( 0 != res ) return res;
    ...
    @Override
    public int hashCode() {
        return Arrays.deepHashCode(new Object[]{created, description, key, name, provider, region, secret});
    }
