...
@Log4j
@Singleton
public class DeletePipelineContainerRepoId extends AjaxHelper<EuropaRequestContext>
{
    @Inject
    ...
    public DeletePipelineContainerRepoId()
    {
    ...
    public Object get(AjaxRequest ajaxRequest, EuropaRequestContext requestContext)
    {
        ...
        _db.setContainerRepo(pipelineId, domain, null);
